    ...
    return (
        <>
            <section className="text-gray-400 bg-black body-font relative">
                <div className="container px-5 pt-[5rem] mx-auto">
                    <div className="flex flex-col text-center w-full mb-10">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Contact Me</h1>
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base w-1/2">Explore my creative journey at <Link href='' className='text-textViolet hover_text-purple-300 duration-300'>Portcity</Link> and let the work speak for itself. Give your opinions feel free to <span className='text-textViolet'>contact me </span>for any help.</p>
                    </div>
                    <div className="lg:w-1/2 md:w-2/3 mx-auto w-[50vw]">
                        <div className="flex flex-wrap -m-2">
                            ...
                            <div className="p-2 w-full">
                                <div className="relative">
                                    ...
                                    <textarea id="message" name="message" className="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:border-indigo-500 focus:bg-gray-900 focus:ring-2 focus:ring-indigo-900 h-28 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"/>
                                </div>
                            </div>
                            <div className="p-2 w-full">
