        ...
        <>
            ...
            <div className='w-full h-[45vh] flex justify-between items-center scroll-smooth'>
                <div className='w-full h-full px-4 ov'>
                    <h1 className='animate-text uppercase text-4xl tracking-normal flex'>Digpal Singh Rathore<div className='animate-ball w-[1rem] h-[1rem] bg-violet-500 ml-2 rounded-full'></div></h1>
                    ...
                    <div className='mt-6 flex justify-center items-center gap-10'>
                        <Link href="" className='flex justify-center items-center gap-2 text-sm'>
